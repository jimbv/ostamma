            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="contact-wrapper form-style-two pt-25 pb-25 pl-25 pr-25" style='background:#B8E2F1;border-radius:15px;'>
                        <h4 class="contact-title pb-10"><i class="lni lni-add-files"></i> Consulta</span></h4>
                ...
                <a href="http://www.ammasalud.com.ar/autogestion/">
                    <img src="imgs/autogestion.jpg" alt="Acceso a Autogestión" style='width:100%;border-radius:7px;'/>
                </a> 
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
