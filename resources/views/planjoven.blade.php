...
@section('contenido')
<section id="contenido" class="contact-area pt-5 pb-3" style="background:#FFF;">
    <div class="container">
        <div class="row">
            <div class="col-md-4 "> </div>
            <div class="col-md-4 text-center">
                <img src="/imgs/joven.png" alt="Plan joven" style="max-width:400px;width:100%;">
            </div>
            <div class="col-md-4"></div>
        </div>
        <div class="col-md-12">
            ...
            <div class="container">
                ...
                <div class="row center">
                    <div class="col-md-12 text-center">
                        <br>
                        <a href="/contacto" style="padding-top:20px;display:inline-block;">
                ...
                <div class="row" style="background:#D7EEF6;padding:20px;">
                    <div class="col-md-12 pt-10">
                        <h4>PRESTACIONES AMBULATORIAS</h4>
                        <p></p><br> <br>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row" style="padding:20px;">
                    ...
                    <div class="col-md-6">
                        Cobertura del 60% de vademecum. <br>
                ...
                <div class="row" style="background:#D7EEF6;padding:20px;">
                    ...
                    <div class="col-md-6">
                        Cobertura del 100% en habitación compartida.<br>Habitación privada, por reintegro.
                    </div>
                    <div class="col-md-12">
                        <hr>
                    </div>
                ...
                <div class="row" style="padding:20px;">
                    ...
                    <div class="col-md-6">
                        Cobertura del 70% de soporte plantares.<br>Cobertura del 70% en calzado ortopédico. Un par al año, por reintegro.
                    </div>
                    <div class="col-md-12">
                        <hr>
                    </div>
                    ...
                    <div class="col-md-6">
                        Cobertura del 100%, hasta 15 años de edad.<br>Mayor de 15 años, 1 por año. <br>Por reintegro.
                    </div>
                    <div class="col-md-12">
                        <hr>
                    </div>
                ...
                <div class="row" style="background:#D7EEF6;padding:20px;">
                    <div class="col-md-12 pt-10">
                        <h4>SERVICIO DE SALUD MENTAL </h4>
                        <p></p><br> <br>
                    </div>
                    <div class="col-md-6">
                        PSICOLOGÍA
                    ...
                    <div class="col-md-6">
                        Cobertura de 40 sesiones al año.<br>Con coseguro (*).
                    </div>
                    <div class="col-md-12">
                        <hr>
                    </div>
                ...
                <div class="row" style="padding:20px;">
                    ...
                    <div class="col-md-6">
                        Cobertura de 4 prestaciones por mes. <br>Con coseguro (*). <br>Financiación en ortodoncia e implantes.
                    </div>
                ...
                <div class="row" style="background:#D7EEF6;padding:20px;">
                    <div class="col-md-12 pt-10">
                        ...
                        <p style="text-align: justify;">
                            Se reconoce un par de lentes aéreos con cristales blancos y orgánicos
                            monofocales y un par de lentes de contacto por año calendario,
                            siempre que no se hayan solicitado previamente lentes bifocales
                            o multifocales.
                        </p>

                        <p style="text-align: justify;">
                            La cobertura se brindará a través de las Ópticas de Mutual Oñativia
                            y/o AMEC; de lo contrario será por reintegro a los valores
                            establecidos en el Nomenclador Interno.
                        </p>

                        <p style="text-align: justify;">
                            Descuento de hasta el 30% sobre el saldo a cargo del beneficiario
                            en Ópticas Oñativia.
                        </p>
                    </div>
                </div>
                ...
                <div class="row" style="padding:20px;background:#DDD;border-radius:6px;">
                    <div class="col-md-12">
                        (*) Mayores de 18 años y menores de 30 años, que no tengan cobertura de salud. Los requisitos para permanecer en este plan son: Soltero/a y sin hijos.
                        Atención primaria de salud en centros médicos de Maradona Salud en las localidades de Villa María, Bell Ville, Rio Cuarto, Córdoba, Gral. Cabrera.
                        Las prestaciones de farmacia que ofrece el Plan son en la red de Farmacia Oñativia.
                    </div>
                </div>
            </div>
        </div>
