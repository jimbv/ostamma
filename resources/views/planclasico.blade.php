...
<section id="contenido" class="contact-area pt-5 pb-3" style="background:#FFF;"> 
        ...
        <div class="row">
            <div class="col-md-4 "> </div>
                <div class="col-md-4 text-center">
                    <img src="/imgs/clasico.png" alt="Plan Clásico" style="max-width:400px;width:100%;">
                </div>
            <div class="col-md-4"></div>
        </div>
        <div class="col-md-12">
        ...
        <div class="row" style="background:#D7EEF6;padding:20px;">
            ...
            <div class="col-md-6">
            Por mes 2 consultas. Con coseguro. 
            </div>
            ...
            <div class="col-md-6">
            Cobertura de 25 sesiones al año. Con coseguro.
            </div> 
            <div class="col-md-12"><hr></div>
            <div class="col-md-6">
        ...
        <div class="row" style="padding:20px;">
            ...
            <div class="col-md-6">
            Cobertura del 40% de vademecum. <br>
        ...
        <div class="row" style="background:#D7EEF6;padding:20px;">
            ...
            <div class="col-md-6">
            Cobertura del 100%, hasta 30 días por año.
            </div>
            <div class="col-md-12"><hr></div><div class="col-md-6">
        ...
        <div class="row" style="padding:20px;">
            ...
            <div class="col-md-6">
            Cobertura del 50% de soporte plantares.<br>Cobertura de un par al año, por reintegro.
            </div>
            <div class="col-md-12"><hr></div>
            <div class="col-md-6">
            AUDIFONOS
            ...
            <div class="col-md-6">
            Cobertura del 100%, hasta 15 años de edad.<br>Mayor de 15 años.
            </div> 
            <div class="col-md-12"><hr></div>
        </div>
        <div class="row" style="background:#D7EEF6;padding:20px;">
            ...
            <div class="col-md-6">
            Cobertura de 30 sesiones al año.<br>Con coseguro.
            </div>
            <div class="col-md-12"><hr></div>
            <div class="col-md-6">
            PSIQUIATRIA
        ...
        <div class="row" style="padding:20px;">
            ...
            <div class="col-md-6">
            Cobertura de 2 prestaciones por mes. <br>Con coseguro. 
            </div>
