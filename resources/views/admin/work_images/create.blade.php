        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('work_images') }}" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="title" name="title" oninput="slugGenerate();" type="text" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" required autocomplete="name" autofocus />
